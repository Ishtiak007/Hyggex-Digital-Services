                ...
                <div className="text-center">
                    ...
                    <div className="w-[680px] h-[380px] flex flex-col custom-gradient rounded-[42.51px]">
                        <div className="flex justify-between">
                            <div className="ml-8 mt-8"><FaRegLightbulb className="text-white text-xl font-bold"></FaRegLightbulb></div>
                            <div className="mr-8 mt-8"><HiSpeakerWave className="text-white text-xl font-bold"></HiSpeakerWave></div>
                        </div>
                    ...
                    <div className="flex justify-between items-center my-5 p-4">
                        <div className="ml-5">
                            <h1><FaArrowRotateRight className="text-[#06286E] text-[20px] font-bold"></FaArrowRotateRight></h1>
                        </div>
                        <div>
                            <div className="flex justify-center gap-5 items-center">
                                <div className="h-[40px] w-[42px] rounded-full flex justify-center items-center bg-gradient-to-r from-[#06286E] to-[#164EC0]"><MdArrowBackIos className="text-white  text-center text-[20px] font-bold"></MdArrowBackIos></div>
                                <div><h1 className="text-[#202B37] text-[18px] font-medium inter-font">01/10</h1></div>
                                <div className="h-[40px] w-[42px] rounded-full flex justify-center items-center bg-gradient-to-r from-[#06286E] to-[#164EC0]"><MdArrowForwardIos className="text-white  text-center text-[20px] font-bold"></MdArrowForwardIos></div>
                            </div>
                        </div>
                        <div className="ml-5">
                            <h1><RiFullscreenFill className="text-[#06286E] text-[20px] font-bold"></RiFullscreenFill></h1>
                        </div>
                    </div>
                </div>
            </div>
